...
public final class ConstantesBaseDatos {
    ...
    public static final String TABLA_LIKES = "mascota_likes";
    public static final String TABLA_LIKES_ID = "id";
    public static final String TABLA_LIKES_ID_MASCOTA = "id_mascota";
    public static final String TABLA_LIKES_LIKES= "likes";
